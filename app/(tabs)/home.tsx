      ...
      >
        ...
        >
          ...
          <ActionTile
            ...
            icon={<Icons.Refresh color={colors.ink} size={18} />}
            title="REORDER"
          />
        </View>
...
function ActionTile({ tone, big, icon, kicker, title, flex, onPress }: any) {
  ...
  return (
    ...
    >
      ...
      <View>
        {kicker && (
          <Mono size={8} color={isInk ? "rgba(255,241,220,0.7)" : colors.mute}>
            {kicker}
          </Mono>
        )}
        <Display size={big ? 18 : 14} color={isInk ? colors.cream : colors.ink}>
          {title}
        </Display>
      </View>
    </Pressable>
...
function BigFoodCard({ tone, title, meta, tag, badge, image }: any) {
  return (
    <View
      style={{
        width: 220,
    ...
    >
      ...
      <View style={{ position: "absolute", left: 16, right: 16, bottom: 14 }}>
        ...
        <Display size={22} color={colors.cream} style={{ marginTop: 6 }}>
          {title}
        </Display>
        <Body
          weight="500"
...
function MidFoodCard({ tone, title, meta, rank, image }: any) {
  return (
    <View style={{ width: 160, gap: 8 }}>
      ...
      <View>
        <Display size={16} color={colors.ink}>
          {title}
        </Display>
...
function PortraitCard({ tone, title, addicts, tag, rank, image }: any) {
  return (
    <View
      style={{
        width: 220,
    ...
    >
      ...
      <View style={{ position: "absolute", left: 18, right: 18, bottom: 18 }}>
        ...
        <Display size={26} color={colors.cream} style={{ marginTop: 10 }}>
          {title}
        </Display>
        <Body
          weight="500"
